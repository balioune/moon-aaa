...
public class TokenListBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.aaa.yang.authn.claims.rev141029.token_cache_times.TokenList> {
    ...
    public TokenListBuilder setKey(TokenListKey value) {
        this._key = value;
        return this;
    }
    
    public TokenListBuilder setUserId(java.lang.String value) {
        this._userId = value;
        return this;
    }
    
    public TokenListBuilder setUserTokens(List<UserTokens> value) {
    ...
    private static final class TokenListImpl implements TokenList {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((_userTokens == null) ? 0 : _userTokens.hashCode());
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (_userTokens == null) {
                if (other.getUserTokens() != null) {
                    return false;
                }
            } else if(!_userTokens.equals(other.getUserTokens())) {
                return false;
            }
