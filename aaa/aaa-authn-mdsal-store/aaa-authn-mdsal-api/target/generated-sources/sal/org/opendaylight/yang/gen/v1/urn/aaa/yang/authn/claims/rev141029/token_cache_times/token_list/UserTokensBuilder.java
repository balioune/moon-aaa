...
public class UserTokensBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.aaa.yang.authn.claims.rev141029.token_cache_times.token_list.UserTokens> {
    ...
    public UserTokensBuilder setExpiration(java.lang.Long value) {
        this._expiration = value;
        return this;
    }
    
    public UserTokensBuilder setKey(UserTokensKey value) {
        this._key = value;
        return this;
    }
    ...
    public UserTokensBuilder setTimestamp(BigInteger value) {
        if (value != null) {
     ...
     */
    @Deprecated
    public static List<Range<BigInteger>> _timestamp_range() {
        final List<Range<BigInteger>> ret = new java.util.ArrayList<>(1);
        ret.add(Range.closed(BigInteger.ZERO, new BigInteger("18446744073709551615")));
        return ret;
    }
    
    public UserTokensBuilder setTokenid(java.lang.String value) {
        this._tokenid = value;
        return this;
    }
    ...
    private static final class UserTokensImpl implements UserTokens {
        ...
        public int hashCode() {
            ...
            final int prime = 31;
            int result = 1;
            result = prime * result + ((_expiration == null) ? 0 : _expiration.hashCode());
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            } else if(!_expiration.equals(other.getExpiration())) {
                return false;
            }
            if (_key == null) {
            ...
            } else if(!_tokenid.equals(other.getTokenid())) {
                return false;
            }
