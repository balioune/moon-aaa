...
public class TokenCacheTimesBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.aaa.yang.authn.claims.rev141029.TokenCacheTimes> {
    ...
    public TokenCacheTimesBuilder setTokenList(List<TokenList> value) {
    ...
    private static final class TokenCacheTimesImpl implements TokenCacheTimes {
        ...
        public int hashCode() {
            ...
            final int prime = 31;
            int result = 1;
            result = prime * result + ((_tokenList == null) ? 0 : _tokenList.hashCode());
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (_tokenList == null) {
                if (other.getTokenList() != null) {
                    return false;
                }
            } else if(!_tokenList.equals(other.getTokenList())) {
                return false;
            }
