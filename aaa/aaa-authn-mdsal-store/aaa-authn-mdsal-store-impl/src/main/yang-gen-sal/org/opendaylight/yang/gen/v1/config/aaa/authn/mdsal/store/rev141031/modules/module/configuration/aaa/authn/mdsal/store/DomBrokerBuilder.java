 ...
 *
 */
public class DomBrokerBuilder implements Builder <org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker> {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker>>, Augmentation<org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker>> augmentation = Collections.emptyMap();
    ...
    public DomBrokerBuilder(DomBroker base) {
        ...
        if (base instanceof DomBrokerImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker>) base;
    ...
    */
    ...
    public DomBrokerBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class DomBrokerImpl implements DomBroker {
        ...
        private Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker>>, Augmentation<org.opendaylight.yang.gen.v1.config.aaa.authn.mdsal.store.rev141031.modules.module.configuration.aaa.authn.mdsal.store.DomBroker>> augmentation = Collections.emptyMap();
