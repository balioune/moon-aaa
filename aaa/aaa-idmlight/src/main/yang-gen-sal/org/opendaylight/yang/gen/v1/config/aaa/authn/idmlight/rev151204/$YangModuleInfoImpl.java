...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "aaa-idmlight";
    private final String namespace = "config:aaa:authn:idmlight";
    private final String revision = "2015-12-04";
    private final String resourcePath = "/META-INF/yang/aaa-idmlight.yang";
