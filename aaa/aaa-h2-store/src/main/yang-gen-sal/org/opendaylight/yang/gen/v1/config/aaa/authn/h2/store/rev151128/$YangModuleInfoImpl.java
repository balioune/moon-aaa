...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "aaa-h2-store";
    private final String namespace = "config:aaa:authn:h2:store";
    private final String revision = "2015-11-28";
    private final String resourcePath = "/META-INF/yang/aaa-h2-store.yang";
