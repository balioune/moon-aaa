 ...
 *
 */
public class AaaAuthzServiceBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.aaa.authz.srv.rev140701.modules.module.configuration.AaaAuthzService> {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.aaa.authz.srv.rev140701.modules.module.configuration.AaaAuthzService>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.aaa.authz.srv.rev140701.modules.module.configuration.AaaAuthzService>> augmentation = Collections.emptyMap();
    ...
    public AaaAuthzServiceBuilder(AaaAuthzService base) {
        ...
        if (base instanceof AaaAuthzServiceImpl) {
            AaaAuthzServiceImpl impl = (AaaAuthzServiceImpl) base;
            if (!impl.augmentation.isEmpty()) {
                this.augmentation = new HashMap<>(impl.augmentation);
            }
        } else if (base instanceof AugmentationHolder) {
            @SuppressWarnings("unchecked")
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.aaa.authz.srv.rev140701.modules.module.configuration.AaaAuthzService> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.aaa.authz.srv.rev140701.modules.module.configuration.AaaAuthzService>) base;
    ...
    public AaaAuthzServiceBuilder setAction(final java.lang.String value) {
        this._action = value;
        return this;
    }
    
     
    public AaaAuthzServiceBuilder setAuthzRole(final java.lang.String value) {
        this._authzRole = value;
        return this;
    }
    
     
    public AaaAuthzServiceBuilder setDataBroker(final DataBroker value) {
        this._dataBroker = value;
        return this;
    }
    
     
    public AaaAuthzServiceBuilder setDomBroker(final DomBroker value) {
        this._domBroker = value;
        return this;
    }
    
     
    public AaaAuthzServiceBuilder setPolicies(final List<Policies> value) {
        this._policies = value;
        return this;
    }
    
     
    public AaaAuthzServiceBuilder setResource(final ResourceType value) {
        this._resource = value;
        return this;
    }
    
     
    public AaaAuthzServiceBuilder setRole(final RoleType value) {
        this._role = value;
        return this;
    }
    
     
    public AaaAuthzServiceBuilder setService(final ServiceType value) {
        this._service = value;
        return this;
    }
    ...
    public AaaAuthzServiceBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.aaa.authz.srv.rev140701.modules.module.configuration.AaaAuthzService>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class AaaAuthzServiceImpl implements AaaAuthzService {
        ...
        public int hashCode() {
            ...
            result = prime * result + Objects.hashCode(_authzRole);
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!Objects.equals(_authzRole, other.getAuthzRole())) {
                return false;
            }
