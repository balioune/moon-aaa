...
public abstract class AbstractAuthzSrvModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractAuthzSrvModule> implements org.opendaylight.controller.config.yang.config.aaa_authz.srv.AuthzSrvModuleMXBean,org.opendaylight.controller.config.yang.md.sal.dom.BrokerServiceInterface {
    ...
    public boolean isSame(AbstractAuthzSrvModule other) {
        ...
        if (!java.util.Objects.deepEquals(domBroker, other.domBroker)) {
            return false;
        }
        if(domBroker!= null) {
        ...
        if (!java.util.Objects.deepEquals(resource, other.resource)) {
            return false;
        }
        if (!java.util.Objects.deepEquals(action, other.action)) {
            return false;
        }
        if (!java.util.Objects.deepEquals(service, other.service)) {
            return false;
        }
        if (!java.util.Objects.deepEquals(role, other.role)) {
            return false;
        }
        if (!java.util.Objects.deepEquals(authzRole, other.authzRole)) {
            return false;
        }
        if (!java.util.Objects.deepEquals(policies, other.policies)) {
            return false;
        }
