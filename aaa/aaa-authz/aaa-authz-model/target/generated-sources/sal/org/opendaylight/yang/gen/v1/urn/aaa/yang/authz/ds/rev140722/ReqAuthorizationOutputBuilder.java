...
public class ReqAuthorizationOutputBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.aaa.yang.authz.ds.rev140722.ReqAuthorizationOutput> {
    ...
    public ReqAuthorizationOutputBuilder setAuthorizationResponse(AuthorizationResponseType value) {
    ...
    private static final class ReqAuthorizationOutputImpl implements ReqAuthorizationOutput {
        ...
        public int hashCode() {
            ...
            final int prime = 31;
            int result = 1;
            result = prime * result + ((_authorizationResponse == null) ? 0 : _authorizationResponse.hashCode());
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (_authorizationResponse == null) {
                if (other.getAuthorizationResponse() != null) {
                    return false;
                }
            } else if(!_authorizationResponse.equals(other.getAuthorizationResponse())) {
                return false;
            }
