...
public class ReqAuthorizationInputBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.aaa.yang.authz.ds.rev140722.ReqAuthorizationInput> {
    ...
    public ReqAuthorizationInputBuilder setAction(final ActionType value) {
        this._action = value;
        return this;
    }
    
     
    public ReqAuthorizationInputBuilder setDomainName(final DomainType value) {
        this._domainName = value;
        return this;
    }
    
     
    public ReqAuthorizationInputBuilder setResource(final ResourceType value) {
        this._resource = value;
        return this;
    }
    
     
    public ReqAuthorizationInputBuilder setRole(final RoleType value) {
        this._role = value;
        return this;
    }
    
     
    public ReqAuthorizationInputBuilder setService(final ServiceType value) {
        this._service = value;
        return this;
    }
