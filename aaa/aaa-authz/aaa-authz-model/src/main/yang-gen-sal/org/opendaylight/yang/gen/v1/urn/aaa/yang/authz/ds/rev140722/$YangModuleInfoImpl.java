...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "authorization-schema";
    private final String namespace = "urn:aaa:yang:authz:ds";
    private final String revision = "2014-07-22";
    private final String resourcePath = "/META-INF/yang/authorization-schema.yang";
