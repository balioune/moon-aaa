...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "credential-store";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:aaa:credential-store";
    private final String revision = "2015-02-26";
    private final String resourcePath = "/META-INF/yang/credential-model.yang";
